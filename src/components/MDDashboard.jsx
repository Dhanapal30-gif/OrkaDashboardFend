...
const orkaDivisionsData = [
  {
    ...
    progress: "25%",
    milestones: [
      { text: "Client database creation", percent: 10 },
      { text: "4 Projects", percent: 25 },
      { text: "2 Services", percent: 40 },
      { text: "Identify main/top lead", percent: 60 },
      { text: "Referral marketing for lead", percent: 80 },
      { text: "Sales setup", percent: 100 },
    ],
    status: "Delay",
    currentFocus:
  ...
  },
  {
    ...
    progress: "13%",
    milestones: [
      { text: "4 route BAM Work", percent: 5 },
      { text: "Feasibility", percent: 15 },
      { text: "Prototype", percent: 30 },
      { text: "Production Readiness", percent: 50 },
      { text: "Pilot & Launch", percent: 100 },
    ],
    status: "On Track",
    currentFocus:
  ...
  },
  {
    ...
    progress: "39%",
    milestones: [
      { text: "Supplier Search", percent: 5 },
      { text: "Supplier Finalization", percent: 20 },
      { text: "Business Validation", percent: 40 },
      { text: "Purchase", percent: 50 },
      { text: "QC", percent: 60 },
      { text: "Payment", percent: 70 },
      { text: "Despatch", percent: 80 },
      { text: "BAM", percent: 85 },
      { text: "Procurement & Handover", percent: 90 },
      { text: "Machine Readiness", percent: 92 },
      { text: "Machine Testing", percent: 93 },
      { text: "Machine Performance", percent: 94 },
      { text: "Ingredient R&D", percent: 95 },
      { text: "Machine + Product Integration", percent: 96 },
      { text: "Product Validation", percent: 97 },
      { text: "Final Optimization", percent: 98 },
      { text: "Commercial Readiness", percent: 99 },
      { text: "Pilot", percent: 99 },
      { text: "Final Approval", percent: 100 },
      { text: "Commercial Launch", percent: 100 },
    ],
    status: "Delay",
  ...
  },
  {
    ...
    progress: "1%",
    milestones: [
      { text: "MHS Reference Project Study", percent: 1 },
      { text: "ORKA Scope Standardization", percent: 2 },
      { text: "Site & Design Planning", percent: 4 },
      { text: "BOQ & Costing", percent: 6 },
      { text: "Procurement", percent: 8 },
      { text: "Site Execution", percent: 10 },
      { text: "Testing & Handover", percent: 12 },
      { text: "ORKA Standardization", percent: 15 },
    ],
    status: "Delay",
